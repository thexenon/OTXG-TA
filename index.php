            ...
            <div class="formsdiv">
                ...
                <form id="registerform" class="forms" action="forms.php" method="post" auto_complete="off">
                    ...
                    <label class="float" for="EntrepreneurialCourses"> Entrepreneurial Courses <span class="red">*</span><br>
                        ...
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Makeup" id="" onclick="chklim(0)">Makeup</label><br>
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Braiding & Wig making" id="" onclick="chklim(1)">Braiding & Wig making</label><br>
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Yoghurt making" id="" onclick="chklim(2)">Yoghurt making</label><br>
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Beads making" id="" onclick="chklim(3)">Beads making</label><br>
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Shower Gel & Liquid soap making" id="" onclick="chklim(4)">Shower Gel & Liquid soap making</label><br>
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Pastry making" id="" onclick="chklim(5)">Pastry making</label><br>
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Sobolo making" id="" onclick="chklim(6)">Sobolo making</label><br>
                        <label><input type="checkbox" name="EntrepreneurialCourses[]" value="Sewing & Tailoring" id="" onclick="chklim(7)">Sewing & Tailoring</label><br>
                    </label>
                    <div class="clear"></div>
                    <br>
                    <br>
                    <label class="float" for="ShirtSizes"> Shirt Sizes <span class="red">*</span><br>
                        ...
                        <label>White <input type="radio" name="ShirtSizes" value="White M" id="">M</label>
                        <label><input type="radio" name="ShirtSizes" value="White L" id="">L</label>
                        <label><input type="radio" name="ShirtSizes" value="White XL" id="">XL</label>
                        <label><input type="radio" name="ShirtSizes" value="White XXL" id="">XXL</label><br>
                        ...
                        <label>Seablue <input type="radio" name="ShirtSizes" value="Seablue M" id="">M</label>
